 ...
 * @author Lyria S.A.
 */
public class PrintVelocityReservationBehavior extends LyPrintVelocityModelBehavior
{
	 ...
	 */
	public String getOutput(LyPrintVelocityModelController printer)
	{
	 ...
	 */
	public String getModel(LyPrintVelocityModelController printer)
	{
	 ...
	 */
	public String getCommand(LyPrintVelocityModelController printer)
	{
	 ...
	 */
	public boolean printEnd(LyPrintVelocityModelController printer)
	{
		LyEnvironment env = printer.getEnvironment();
		String		  viewerType = env.getEnv("LY_VIEWER_TYPE");
